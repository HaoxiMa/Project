...
View(Fianl_summary)
#Therefore, we choose to use SVM with Gaussian Kernel

#Applying k-Fold cross validation to evaluate the over all prediction accuracy
...
mean(as.numeric(cv))
#Finally,the prediction accuracy can be given at 93.62%
